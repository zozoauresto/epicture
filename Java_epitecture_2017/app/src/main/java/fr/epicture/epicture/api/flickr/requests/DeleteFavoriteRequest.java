...
public class DeleteFavoriteRequest extends TextPostRequest {

    private static final String URL = "https://www.flickr.com/services/rest";
    private static final String METHOD = "flickr.favorites.remove";

    private FlickrAccount user;
    private String photoid;

    public DeleteFavoriteRequest(@NonNull Context context, FlickrAccount user, String photoid, LoadTextInterface listener) {
